...
import com.guo.android.zhihu_topanswer.fragment.RecyclerViewFragment;
import com.guo.android.zhihu_topanswer.model.TopicModel;
import com.guo.android.zhihu_topanswer.utils.AllTopic;
import com.guo.android.zhihu_topanswer.view.SelectPopupWindow;
...
public class MainActivity extends RxAppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.about:
                ...
                intent.setData(Uri.parse("https://github.com/gyhyyp?tab=repositories"));
            ...
            case R.id.update:
                ...
                updateIntent.setData(Uri.parse("https://github.com/gyhyyp/SOA1/releases"));
    ...
    public void shareText(View view) {
        ...
        shareIntent.putExtra(Intent.EXTRA_TEXT, "Hi,我正在使用" + getString(R.string.app_name) + ",推荐你下载这个app一起玩吧 到https://github.com/gyhyyp/SOA1/releases即可下载");
