...
/**
 * Created by guo on 2016/12/24.
 */

public class AnswersActivity1 extends RxAppCompatActivity {
    ...
    public void initData(final boolean needState) {
        ...
        Observable.create(new Observable.OnSubscribe<Document>() {
            ...
            public List<AnswersModel> call(Document document) {
                ...
                AnswersActivity1.this.title = title;
                detail = detailHtml;
        ...
        if (mRecyclerView.getAdapter() == null) {
            ...
            mRecyclerView.setAdapter(new BaseAdapter() {
                ...
                public void onItemClick(View v, int position) {
                    ...
                    if (position == 0)
                        return;
                    Intent intent = new Intent(AnswersActivity1.this, AnswerDetailActivity.class);
